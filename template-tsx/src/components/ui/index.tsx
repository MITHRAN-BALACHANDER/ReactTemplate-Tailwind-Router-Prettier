...
export const LoadingSpinner: React.FC<LoadingSpinnerProps> = ({ 
  ...
  const sizeClasses: Record<LoadingSpinnerProps['size'] & string, string> = {
    sm: 'w-4 h-4',
    md: 'w-8 h-8',
    lg: 'w-12 h-12',
  }
 ...
 * @param props.variant - Style variant: 'primary', 'secondary', 'outline', 'danger'
 * @param props.size - Size variant: 'sm', 'md', 'lg'
 * @param props.disabled - Whether button is disabled
 * @param props.loading - Whether button is in loading state
 * @param props.className - Additional CSS classes
 * @param props...rest - Additional HTML button attributes
 ...
 * @param props...rest - Additional HTML input attributes
 ...
 * 
 * @param props - Component props
 * @param props.type - Alert type: 'info', 'success', 'warning', 'error'
...
export const Alert: React.FC<AlertProps> = ({ 
  ...
  const types: Record<AlertProps['type'] & string, string> = {
